...
public class Shooter {
    ...
    public boolean isAtSetPoint(double setPointRpms) {
        if (setPointRpms + ShooterConstants.setpointRpmsTolerance > getTopVelocity() && getTopVelocity() > setPointRpms - ShooterConstants.setpointRpmsTolerance
        && setPointRpms + ShooterConstants.setpointRpmsTolerance > getBottomVelocity() && getBottomVelocity() > setPointRpms - ShooterConstants.setpointRpmsTolerance) {
            return true;
        }else {
            return false;
        }
