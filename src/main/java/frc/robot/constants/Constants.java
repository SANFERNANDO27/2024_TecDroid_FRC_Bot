...
public final class Constants {
  ...
  public static class ShooterConstants {
    ...
    public static final double shootVelocity = 2000;

    // Tolerance
    public static final double setpointRpmsTolerance = 300;
  ...
  public static class ShooterPositionerConstants {
    ...
    public static final double shootPosition = 0.08;
    public static final double setPointTolerance = 0.007;
    ...
    public static final double upLimit = 0.11;
  ...
  public static class GameStrategiesConstants {
    public static final boolean limitSwitchIntakeIndexerShooter = true;
